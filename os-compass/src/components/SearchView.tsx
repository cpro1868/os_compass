  ...
  return (
    <div className="flex h-full bg-gray-900 text-gray-100">
      <main className="flex-1 flex flex-col">
        <header className="h-16 bg-gray-800 border-b border-gray-700 flex items-center px-6 flex-shrink-0">
          <div className="relative flex-1 max-w-2xl mx-auto">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
        </header>
        ...
        <div className="flex-1 overflow-auto p-6">
          {!results && !loading && (
            <div className="flex flex-col items-center justify-center h-full text-gray-500">
              <i className="fa-solid fa-robot text-5xl mb-4 text-gray-600" />
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center h-full">
              <i className="fa-solid fa-spinner fa-spin text-3xl text-blue-500 mb-4" />
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className={`text-xs px-2 py-0.5 rounded ${result.source === 'local' ? 'bg-blue-900/40 text-blue-400' : result.source === 'cache' ? 'bg-green-900/40 text-green-400' : 'bg-purple-900/40 text-purple-400'}`}>
                        ...
                        <h3 className="font-medium mb-1">
                          {result.project_name || t('search.unknownProject')}
                        </h3>
                        {result.project_url && (
                          <a
          ...
          <div className="space-y-1">
            {history.map(item => (
              <button
                ...
                className="w-full text-left px-3 py-2 rounded-lg hover:bg-gray-700 transition text-sm text-gray-300 truncate"
              >
                <i className="fa-regular fa-clock mr-2 text-gray-500" />
                {item.query}
              </button>
            ))}
          </div>
