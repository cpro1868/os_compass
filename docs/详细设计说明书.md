...
| 字段 | 类型 | 说明 |
|------|------|------|
| style | VARCHAR(50) PRIMARY KEY | 风格标识（tech_popular/business/tech_blog/brief/humor） |
...
| style | 模板内容 |
|-------|----------|
| tech_popular | 你是一位技术科普作家。请根据以下项目信息写一篇通俗易懂的文章... |
| business | 你是一位商业文案专家。请写一篇突出项目商业价值的推广文章... |
| tech_blog | 你是一位资深开发者。请写一篇深度技术博客... |
| brief | 请简洁明了地介绍这个项目... |
| humor | 请用轻松幽默的语气介绍这个项目... |
