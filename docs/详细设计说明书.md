...
| 命令 | 参数 | 返回值 |
|------|------|--------|
| `create_backup` | - | `Result<BackupInfo, String>` |
| `list_backups` | - | `Result<Vec<BackupInfo>, String>` |
| `restore_backup` | backup_id | `Result<(), String>` |
| `delete_backup` | backup_id | `Result<(), String>` |
