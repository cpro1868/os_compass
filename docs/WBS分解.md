...
| **13.2 数据库层** | 13.2.1 feature_plugins 表初始化 | 低 | M13 |
| | 13.2.2 open_db_at_path 工具函数 | 低 | M13 |
...
|--------|------|
| 意图搜索（联网检索） | 联网搜索 + 一键导入 |
| 情报雷达（RSS 订阅） | RSS 监控 + 通知推送 |
| GitLab/Docker Hub 插件 | 扩展平台支持 |
| 插件热加载与市场 | 运行时加载 + 市场 UI |
| 备份恢复与帮助系统 | 数据备份 + 新手引导 + 快捷键 |
