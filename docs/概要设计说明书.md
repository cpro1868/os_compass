...
| 意图搜索 | **双轨搜索**：本地向量搜索（sqlite-vec）+ LLM 联网搜索 |
...
扩展开源项目管理的数据源，支持 NPM、PyPI、Crates.io 等包管理器平台。
...
| 组件 | 说明 |
|------|------|
| 定时开关 | 显示 OFF/ON 状态，开启后显示当前间隔 |
| 设置按钮 | 打开配置弹窗 |
| 配置弹窗 | 间隔模式/自定义模式选择、通知设置、运行状态 |
| 后台运行 | 关闭主窗口后继续运行 |
| 系统通知 | 新内容时弹窗提醒 |
| 雷达图标徽章 | 显示未读数 |
| 托盘菜单 | 快速开关定时采集 |
