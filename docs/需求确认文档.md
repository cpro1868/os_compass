...
**最后更新**：2026-07-20（新增 M14/M15 功能需求：GitLab/Docker Hub 集成、插件热加载、插件市场、备份恢复、快捷键、首页/引导页）
