...
| 问题编号 | 模块 | 问题 | 持续时间 | 状态 |
|---------|------|------|----------|------|
| ISSUE-001 | 意图搜索 | off_topic 流程不工作 | ~5天 | 未解决 |
...
| 子功能 | Task | 工时 | 状态 |
|--------|------|------|------|
| **M19.1 平台扩展** | Task 1-6 | 18h | ✅ **已完成** |
| M19.2 广告学习 | Task 7-10 | 9h | 🔄 **后端已完成，前端待开发** |
| M19.3 定时采集 | Task 11-15 | 11h | 📋 待开发 |

### M19.2 后端完成

| Task | 内容 | 状态 |
|------|------|------|
| Task 7 | 广告标记 UI（RadarCard 增加按钮+弹窗） | 📋 待开发 |
| Task 8 | LLM 广告判定服务（ad_detector.rs） | ✅ 完成 |
| Task 9 | 屏蔽列表管理（ad_patterns_cmd.rs + CRUD API） | ✅ 完成 |
