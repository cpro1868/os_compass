...
| 阶段 | 状态 | 说明 |
|------|------|------|
| M17 极简首页 | ✅ 已完成 | 包含首页组件、系统托盘 |
| M18 通用分类预置 | 📋 需求初稿 | 三级分类结构已规划 |
...
2. 默认启动页 ✅
3. 极简输入框 ✅
4. URL 平台识别（GitHub/Gitee/GitLab/NPM/PyPI/Crates.io）✅
5. 预览确认 ✅
6. 导入流程：复用 ImportModal ✅
7. 最近项目（5个）✅
8. ~~快捷入口~~ → 移至 M18
9. 主题：跟随 App ✅
10. 系统托盘（图标 + 菜单）✅
...
- 后端命令：`get_recent_projects`, `get_project_preview`
...
| # | 功能 | 说明 |
|---|------|------|
| 1 | 快捷入口 | 首页显示雷达/搜索等快捷入口 |

### 三级分类结构（初稿）
```
├── 1 前端开发
│   ├── 1.1 Web 框架（Vue/React/Angular）
│   ├── 1.2 小程序/跨端
│   └── 1.3 桌面应用
│
├── 2 后端开发
│   ├── 2.1 Web 框架（Django/Flask/Spring）
│   ├── 2.2 微服务/网关
│   └── 2.3 API/中间件
│
├── 3 移动开发
