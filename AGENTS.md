...
| 数据 | 存放位置 | 原因 |
|------|----------|------|
| LLM 配置 | 系统库 | 全局共享，切换仓库不变 |
| 代理配置 | 系统库 | 全局共享，切换仓库不变 |
| 插件启用状态 | 系统库 | 全局共享，切换仓库不变 |
| 情报源 | 系统库 | 全局共享，切换仓库不变 |
| Prompt 模板 | 系统库 | 全局共享，切换仓库不变 |
| 项目数据 | 仓库库 | 按仓库隔离，切换仓库切换 |
| 分类数据 | 仓库库 | 按仓库隔离，切换仓库切换 |
| 雷达采集数据 | 仓库库 | 按仓库隔离，切换仓库切换 |
...
**最后更新**: 2026-07-24（强调系统库恒定、仓库库可改变）
